/*
  description: Icon들의 정보를 static으로 빼놓은 곳
*/
...
class IconImageData {
  ...
  // Framework
  static const flutterIcon = Icon(SimpleIcons.flutter, color: SimpleIconColors.flutter);
  static const flaskIcon = Icon(SimpleIcons.flask, color: SimpleIconColors.flask);
  static const fastApiIcon = Icon(SimpleIcons.fastapi, color: SimpleIconColors.fastapi);
  static const springIcon = Icon(SimpleIcons.springboot, color: SimpleIconColors.springboot);
  static const uiKitIcon = Icon(SimpleIcons.uikit, color: SimpleIconColors.uikit);
  static const mybatisIcon = Icon(SimpleIcons.twitter, color: SimpleIconColors.twitter);
  static const apacheTomcatIcon = Icon(SimpleIcons.apachetomcat, color: SimpleIconColors.apachetomcat);
  ...
  // Database
  static const mySQLIcon = Icon(SimpleIcons.mysql, color: SimpleIconColors.mysql);
  static const sqliteIcon = Icon(SimpleIcons.sqlite, color: SimpleIconColors.sqlite);
  static const firebaseIcon = Icon(SimpleIcons.firebase, color: SimpleIconColors.firebase);
}
